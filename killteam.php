		...
		<div class="ng-cloak" ng-hide="loading">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="eqs" role="tabpanel">
					<div class="row p-0 m-0">
						<div ng-repeat="eq in killteam.equipments track by $index" class="col-12 col-lg-6 col-xl-4" ng-if="eq.eqcategory == 'Equipment' && (settings['shownarrative'] == 'y' || (eq.eqcategory != 'Battle Honour' && eq.eqcategory != 'Battle Scar' && eq.eqcategory != 'Rare Equipment'))">
